...
class SRv6Topo(IPTopo):
    ...
    def build(self, *args, **kwargs):
        ...
        r1 = self.addRouter("r1", lo_addresses=["2042:1:1::1/64", "192.168.1.1/24"])
        r2 = self.addRouter("r2", lo_addresses=["2042:2:2::1/64", "192.168.2.1/24"])
        r3 = self.addRouter("r3", lo_addresses=["2042:3:3::1/64", "192.168.3.1/24"])
        r4 = self.addRouter("r4", lo_addresses=["2042:4:4::1/64", "192.168.4.1/24"])
        r5 = self.addRouter("r5", lo_addresses=["2042:5:5::1/64", "192.168.5.1/24"])
        r6 = self.addRouter("r6", lo_addresses=["2042:6:6::1/64", "192.168.6.1/24"])

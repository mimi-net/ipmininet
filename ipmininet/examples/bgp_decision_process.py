...
class BGPDecisionProcess(IPTopo):
    ...
    def build(self, *args, **kwargs):
        ...
        """
        # Add all routers
        as1r1, as2r1, as2r2, as2r3, x, y, as3r1 = self.addRouters(
            "as1r1", "as2r1", "as2r2", "as2r3", "x", "y", "as3r1", config=RouterConfig
        )

        as1r1.addDaemon(BGP, address_families=(_bgp.AF_INET(networks=("1.2.3.0/24",)),))
        ...
        as3r1.addDaemon(BGP, address_families=(_bgp.AF_INET(networks=("1.2.3.0/24",)),))

...
from ipmininet.router.config import AF_INET6, BGP, AccessList, ebgp_session, set_rr
...
class BGPTopoFull(IPTopo):
    ...
    def build(self, *args, **kwargs):
        ...
        as1r6.get_config(BGP).set_local_pref(
            99, from_peer=as4r1, matching=(al4, al6)
        ).set_med(50, to_peer=as4r1, matching=(al4, al6))

        as4r1.get_config(BGP).set_community(
            "1:80", from_peer=as1r6, matching=(al4, al6)
        ).set_med(50, to_peer=as1r6, matching=(al4, al6))

        as1r5.get_config(BGP).set_local_pref(50, from_peer=as4r2, matching=(al4, al6))
